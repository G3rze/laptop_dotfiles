...
--
-- navigate to vault
vim.keymap.set("n", "<leader>oo", ":cd /home/$USER/My_Things")
--
...
vim.keymap.set("n", "<leader>os", ":Telescope find_files search_dirs={\"/home/gerze/My_Things\"}<cr>")
vim.keymap.set("n", "<leader>oz", ":Telescope live_grep search_dirs={\"/home/gerze/My_Things\"}<cr>")
--
